...
- [ ] data handler
    - [ ] different reconstruction algorithms, generic representation for GUI: modularize
    - [ ] select reference interval (average) instead of point
    - [ ] modularize file readers
    - [x] sentec raw support - unvalidated
